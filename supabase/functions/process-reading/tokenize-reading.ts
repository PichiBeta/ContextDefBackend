...
function buildCodeUnitToCodePointMap(text) {
...
function makeParagraphBlocks(text, cuToCp) {
...
function makeSentenceSpans(text, cuToCp) {
  // Simple rules:
...
export function tokenizeReading(ctx) {
